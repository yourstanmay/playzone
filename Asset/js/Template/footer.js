$(function () {
    var bar = '';
    bar += '<!-- Footer -->';
    bar += '    <center><footer class="container-fluid bg-dark my-0 py-3 text-light" style="position: fixed;bottom: 0;">';
    bar += '        <a href="https://yourstanmay.github.io/" class="mb-0 text-center" style="color:white;">&copy; YoursTanmay 2020-2022</a>';
